MODULE Module1
    ...
    PROC main()
        ...
        WHILE TRUE DO        
		    ...
		    IF blurred THEN
		    	MoveL Offs(overview,0,0,-50),vfast,fine,tGripper\WObj:=wobjTableN;
		    ...
		    IF blurred THEN
		    	MoveL Offs(puck_target, -50, 0, safeHeight+100),vfast,fine,tGripper\WObj:=wobjTableN;
